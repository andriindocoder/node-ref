...
(async () => {                                  // declare function
  ...
  await page.goto('https://en.wikipedia.org/wiki/Fiverr', {waitUntil: 'networkidle2', timeout: 0})
  ...
  await page.pdf({
        path: 'wiki_portrait.pdf',                       // path to save pdf file  
  ...
  setTimeout(async function() {
          await page.pdf({
                path: 'wiki_landscape.pdf',                       // path to save pdf file  
                displayHeaderFooter: false,              // display header and footer (in this example, required!)
                printBackground: true,                  // print background
                // landscape: false,                        // use horizontal page layout
